...
class ApiSettings:
    ...
    sandbox_service_base_url: str
    sandbox_service_token: str | None
    ...
    def from_env(cls) -> "ApiSettings":
        ...
        return cls(
            ...
            workspace_enabled=_bool_env("WORKSPACE_ENABLED", True),
            sandbox_service_base_url=os.getenv(
                "SANDBOX_SERVICE_BASE_URL",
                "http://workspace-aristotle-sandbox:7860",
            ),
            sandbox_service_token=_optional_env("SANDBOX_SERVICE_TOKEN"),
            sandbox_request_timeout_seconds=float(
